 ...
 */
	...
	========================================================================*/
     ...
     //   System.out.println("Islemden etkilenen satir sayisi : " + satirSayisi);
        ...
        /*=======================================================================
		  ORNEK4: isciler tablosuna birden fazla yeni kayit ekleyelim
...
/*
       ...
       // ayri ayri sorgular ile veritabinina tekrar tekrar ulasmak islemlerin
        ...
        // 2. YONTEM (addbatch ve executeBatch() metodlari ile )
        //---------------------------------------------------------
        // addBatch metodu ile SQL ifadeleri gruplandirilabilir ve executeBatch()
        // metodu ile veritabanina bir kere gonderilebilir.
        // executeBatch() metodu bir int [] dizi dondurur. Bu dizi bir ifade sonucunda
        // etkilene satir sayisini gosterir.

        String [] sorgular2 = {"INSERT INTO isciler VALUES(40, 'HR', 6000)",
                               "INSERT INTO isciler VALUES(30, 'LAB', 2000)",
                                 "INSERT INTO isciler VALUES(20, 'ARGE', 4000)"};
